    ...
    <div className="space-y-6">
        ...
        <div className="relative">
          <div className="w-24 h-24 bg-blue-600 rounded-full flex items-center justify-center">
            <span className="text-white text-2xl font-bold">
              {personalInfo.firstName?.[0] || 'U'}{personalInfo.lastName?.[0] || 'U'}
            </span>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <FormField
          ...
          type="number"
          value={personalInfo.yearsExperience || 0}
          onChange={(e) => handleInputChange('personalInfo', 'yearsExperience', parseInt(e.target.value) || 0)}
        />
      </div>
      ...
      <FormField
        ...
        type="textarea"
        value={personalInfo.summary || personalInfo.bio || ''}
